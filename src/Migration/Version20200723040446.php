    ...
    public function up(Schema $schema) : void
    {
        $this->addSql("
            ...
            VALUES
                ...
                (null, 4, 'service_1', 'work'),
                (null, 5, 'service_2', 'connecting'),
                (null, 6, 'service_3', 'disconnected'),
                (null, 7, 'service_1', 'work'),
                (null, 8, 'service_2', 'connecting'),
                (null, 9, 'service_3', 'disconnected'),
                (null, 10, 'service_1', 'work'),
                (null, 1, 'service_1', 'work'),
                (null, 2, 'service_2', 'connecting'),
                (null, 3, 'service_3', 'disconnected'),
                (null, 4, 'service_1', 'work'),
